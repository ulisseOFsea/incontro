...
const APP_NAME = "One to One Cloud";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Workspace per incontri 1-to-1: registra, trascrivi, analizza le opportunità e esporta un report Word.",
      },
      { name: "theme-color", content: "#146ea8" },
    ],
    links: [
